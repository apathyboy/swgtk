...
int main(int argc, char *argv[])
{
    ...
    {        
        ...
        index_files.push_back(swg_directory + "/patch_sku1_14_00.tre");
        index_files.push_back(swg_directory + "/patch_14_00.tre");
        index_files.push_back(swg_directory + "/patch_sku1_13_00.tre");
        index_files.push_back(swg_directory + "/patch_13_00.tre");
        index_files.push_back(swg_directory + "/patch_sku1_12_00.tre");
